...
public class mritestbooking extends AppCompatActivity implements PaymentResultListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mritestbooking);
        ...
        testname.setText(getIntent().getStringExtra("xray_name"));
        testprice.setText(getIntent().getStringExtra("xray_price"));
